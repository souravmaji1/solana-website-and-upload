...
`;
const TikuConatiner = styled.div`
fontsize: 30px;
color: white;
display: flex;
align-items: center;
...
const Home = (props: HomeProps) => {
    ...
    return (
        ...
        <main>
              ...
              <SodaContainer>
                <img src="i.gif" style={{position: "absolute",width: "100%",height: "100%"}}></img>
                <h1 style={{zIndex: 2}}>DANCING  <span>APE</span> CLUB</h1>
            </SodaContainer>
            ...
            <TikuConatiner>
                <h1 style={{fontSize:"70px"}}>Which Edition Will You receive ?</h1>
            </TikuConatiner>
                ...
                <MintContainer>
                    <DesContainer>
                        <NFT elevation={3}>
                            ...
                            <CrossmintPayButton style={{display: "flex",alignItems: "center",justifyContent: "center",margin: "auto"}}
                collectionTitle="stor"
                collectionDescription="sdsdsds"
                collectionPhoto="<COLLECTION_IMAGE_URL>"
                clientId="2c55c811-b142-47d9-b323-dcab893b9641"
            ...
            />
                ...
                <MintContainer>
                    <DesContainer>
                        <NFT elevation={3}>
                            <h2 style={{fontSize: "50px"}}>OG Ape</h2>
                            <br/>
                            <div><Price
                                label={isActive && whitelistEnabled && (whitelistTokenBalance > 0) ? (whitelistPrice + " " + priceLabel) : (price + " " + priceLabel)}/><Image
                                src="2.gif"
